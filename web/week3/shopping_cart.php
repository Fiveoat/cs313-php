    ...
    <div class="container">
        <div class="row">
            ...
            foreach ($_SESSION['cart'] as $id){
                echo "<div class='col-md'><img src='/week3/images/S{$id}.jpg' alt='black diamond camalot'>Size {$id}</div><br><a href='/week3/remove_from_cart.php?id={$id}'>Remove From Cart</a>";
            }
            ?>
        </div>
    </div>
