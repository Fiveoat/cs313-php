...
<body>
    ...
    <main>
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            $db = getConnection();
            foreach ($db->query("SELECT * FROM bookings b INNER JOIN homes h ON h.home_id = b.home_id INNER JOIN locations l ON l.location_id = h.location_id WHERE b.renter = {$user_id} AND booked = TRUE;") as $row) {
