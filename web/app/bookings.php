    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                <?php
                $db = getConnection();
                foreach ($db->query('SELECT * FROM homes h INNER JOIN locations l ON h.location_id = l.location_id INNER JOIN bookings b ON b.home_id = h.home_id WHERE b.booked != TRUE;') as $row) {
                    $home_id = $row['home_id'];
